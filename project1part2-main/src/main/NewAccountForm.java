		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(newUser == null) {
						newUser = new User(name, pass, user_role,"src/data/"+name+"tasks.txt");
						if(accountManager.saveUser(newUser)) {
							accountManager.insertLast(newUser);
						}else {
							newUser.getDataFile().delete();
						...
						AccountManager.getUserService().editAccount(accountManager.getIndex(),newUser);
