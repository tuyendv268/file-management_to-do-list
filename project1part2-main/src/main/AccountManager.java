...
public class AccountManager extends JPanel implements ActionListener{
	...
	public void insertFirst(User t) {
		tableModel.insertRow(0, new Object[] {t.getUsername(), t.getPassword(), t.getDataFile().getAbsolutePath(),t.getRole()});
	}
	public void insertLast(User t) {
		tableModel.addRow(new Object[] {t.getUsername(), t.getPassword(), t.getDataFile().getAbsolutePath(),t.getRole()});
	}
	public void init() {
